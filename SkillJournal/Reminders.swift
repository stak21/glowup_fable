        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack(spacing: 8) {
                            DatePicker("", selection: $newTime, displayedComponents: .hourAndMinute)
                                .labelsHidden()
                            TextField("What for? e.g. Water the ferns 🌿", text: $newLabel)
                        ...
                        Button {
                            ...
                            store.reminders.append(Reminder(
                                label: label.isEmpty ? "Routine time" : label,
                    ...
                    Text("If notifications aren't arriving, check Settings → Notifications → Skill Journal and make sure Allow Notifications is on.")
                        .font(.caption).foregroundColor(.soft)
                        .padding(.top, 4)
                }
                .padding(16)
...
struct ReminderEditSheet: View {
    ...
    private func save() {
        ...
        updated.label = trimmed.isEmpty ? "Routine time" : trimmed
